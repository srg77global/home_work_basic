...
func (x *BookProto) GetAuthor() string {
	if x != nil {
		return x.Author
	}
	return ""
...
func (x *BookProto) GetYear() int32 {
	if x != nil {
		return x.Year
	}
	return 0
...
func (x *BookProto) GetSize() int32 {
	if x != nil {
		return x.Size
	}
	return 0
...
func (x *BookProto) GetRate() float32 {
	if x != nil {
		return x.Rate
	}
	return 0
...
var file_proto_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x85, 0x01, 0x0a, 0x09, 0x42, 0x6f, 0x6f, 0x6b, 0x50, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02,
	...
	0x59, 0x65, 0x61, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x53, 0x69, 0x7a, 0x65, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x04, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x52, 0x61, 0x74, 0x65,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x02, 0x52, 0x04, 0x52, 0x61, 0x74, 0x65, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_proto_goTypes = []interface{}{
	(*BookProto)(nil), // 0: proto.BookProto
}
